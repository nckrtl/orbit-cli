...
All tests must be written using Pest. Use `php orbit make:test --pest {name}`.

The `{name}` argument should include only the path and test name, but should not include the test suite.
- Incorrect: `php orbit make:test --pest Feature/SomeFeatureTest` will generate `tests/Feature/Feature/SomeFeatureTest.php`
- Correct: `php orbit make:test --pest SomeControllerTest` will generate `tests/Feature/SomeControllerTest.php`
- Incorrect: `php orbit make:test --pest --unit Unit/SomeServiceTest` will generate `tests/Unit/Unit/SomeServiceTest.php`
- Correct: `php orbit make:test --pest --unit SomeServiceTest` will generate `tests/Unit/SomeServiceTest.php`
...
- Run minimal tests with filter before finalizing: `php orbit test --compact --filter=testName`.
- Run all tests: `php orbit test --compact`.
- Run file: `php orbit test --compact tests/Feature/ExampleTest.php`.
