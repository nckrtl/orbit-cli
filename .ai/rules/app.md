...
## Review orbit-old before inventing behavior
Before inventing command or local OS-adapter behavior, review /home/nckrtl/orbit-old for proven validation, output, error, idempotency, request-ID, redaction, and adapter test invariants. Port useful behavior only; do not copy its Agent, hidden transport, generic executor, or retired infrastructure architecture.
